...
import { SideLink } from '@/shared/data/side-links';
...
export default function Nav({
  ...
  return (
    <div
      ...
      className={cn(
        'group border-b bg-[#FAFAFA] py-2 transition-[max-height,padding] duration-500 data-[collapsed=true]:py-2 md:border-none',
        className
      )}
    >
